...
function setup() {
  ...
  boidsViewSlider = createSlider(1, 50, 50, 0.05);
  boidsViewSlider.position(5, 100);
  alignSlider = createSlider(0, 5, 1, 0.05);
  alignSlider.position(5, 130);
  cohesionSlider = createSlider(0, 5, 1, 0.05);
  cohesionSlider.position(5, 160);
  separationSlider = createSlider(0, 5, 1, 0.05);
